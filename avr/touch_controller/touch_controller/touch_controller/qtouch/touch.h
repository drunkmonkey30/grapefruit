...
#define NODE_0_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(0), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_2), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16        \
	}
#define NODE_1_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(1), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_2), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16        \
	}
#define NODE_2_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(2), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_2), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16        \
	}
#define NODE_3_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(3), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_2), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16        \
	}
#define NODE_4_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(4), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_2), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16        \
	}
#define NODE_5_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(5), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_2), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16        \
	}
#define NODE_6_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(6), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_2), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16        \
	}
#define NODE_7_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(7), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_2), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16        \
	}
#define NODE_8_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(8), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_2), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16        \
	}
#define NODE_9_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(9), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_2), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16        \
	}
#define NODE_10_PARAMS                                                                                                 \
	{                                                                                                                  \
		X_NONE, Y(10), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_2), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16       \
	}
#define NODE_11_PARAMS                                                                                                 \
	{                                                                                                                  \
		X_NONE, Y(11), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_2), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16       \
	}
#define NODE_12_PARAMS                                                                                                 \
	{                                                                                                                  \
		X_NONE, Y(12), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_2), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16       \
	}
#define NODE_13_PARAMS                                                                                                 \
	{                                                                                                                  \
		X_NONE, Y(13), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_2), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16       \
	}
#define NODE_14_PARAMS                                                                                                 \
	{                                                                                                                  \
		X_NONE, Y(14), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_2), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16       \
	}
#define NODE_15_PARAMS                                                                                                 \
	{                                                                                                                  \
		X_NONE, Y(15), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_2), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16       \
	}
